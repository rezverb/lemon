...
$(function(){
    ...
    var icons = new Array('apartment', 'building-area', 'condo', 'cottage', 'family-house', 'flatblocks', 'house', 'single-home', 'villa');
...
//        contents.push('<div class="infobox"><div class="infobox-header"><h3 class="infobox-title"><a href="#">30 Miller Pl Apt 3</a></h3><h4 class="infobox-subtitle"><a href="#">San Francisco, CA</a></h4></div><div class="infobox-picture"><a href="#"><img src="'+$("#base_url").val()+'assets/img/tmp/properties/medium/'+Math.floor((Math.random()*10)+1) +'.jpg" alt=""></a><div class="infobox-price">$ 13,000</div></div></div>');
//        types.push('apartment');
//        images.push('<img src="'+$("#base_url").val()+'assets/img/icons/' + icon_name + '.png" alt="">');
//    }


    function set_mapdetails(property_icon,property_address,property_name,property_pic,latitude,longitude,currency_sym,price)
    {


        locations.push(new Array(latitude, longitude));
        types.push('apartment');
        images.push('<img src="'+$("#base_url").val()+'assets/img/icons/' + property_icon + '" alt="">');
        contents.push('<div class="infobox"><div class="infobox-header"><h3 class="infobox-title"><a href="#">'+property_name+'</a></h3><h4 class="infobox-subtitle"><a href="#">'+property_address+'</a></h4></div><div class="infobox-picture"><a href="#"><img src="'+$("#base_url").val()+'uploads/properties/medium/'+property_pic+'" alt=""></a><div class="infobox-price">'+currency_sym+" "+price+'</div></div></div>');
    ...
    if ($('#map').length !== 0) {
        var map = $('#map').aviators_map({
            ...
            types: types,
            images: images,
            transparentMarkerImage:  $("#base_url").val()+'assets/img/marker-transparent.png',
            transparentClusterImage: $("#base_url").val()+'assets/img/clusterer-transparent.png',
            zoom: 11,
            center: {
                latitude: 40.67,
                longitude: -73.94
    ...
    $( window ).load(function() {
       ...
       var p_property_icon = $("#p_property_icon").val();
       var p_title = $("#p_title").val();
       var p_property_pic = $("#p_property_pic").val();
       var p_latitude = $("#p_latitude").val();
       var p_longitude = $("#p_longitude").val();
       var p_currency_sym = $("#p_currency_sym").val();
       var p_price = $("#p_price").val();

        set_mapdetails(p_property_icon,p_address,p_title,p_property_pic,p_latitude,p_longitude,p_currency_sym,p_price);
